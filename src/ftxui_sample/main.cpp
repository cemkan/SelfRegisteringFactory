...
// configuration step. It creates a namespace called `SelfRegisteringFactory`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", SelfRegisteringFactory::cmake::project_name, SelfRegisteringFactory::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", SelfRegisteringFactory::cmake::project_version);
      return EXIT_SUCCESS;
    }
